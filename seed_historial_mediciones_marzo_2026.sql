-- Seed mensual de mediciones para pruebas de graficos.
-- Genera un mes de vibraciones y termografia sobre equipos reales
-- usando trabajadores reales ya presentes en la operacion.
--
-- Compatibilidad:
-- - Si existe public.mediciones, inserta ahi.
-- - Si no existe, usa public.historial_mediciones.
--
-- Fecha del seed: marzo 2026
